...
class AlgoliaSearch {
  static final Algolia algolia =
      Algolia.init(applicationId: "9RKZ93TV3X", apiKey: "1f2396c20f086c62cf935e26e7021dfe");
  ...
  Future sendData(Product product) async {
    return await algolia.instance.index('products').object(product.id).setData(product.toMap());
  }
}
